...
export const cardFragmentShader = /* glsl */ `
  ...
  void main() {
    // Sample the assigned texture and render it edge to edge with hard edges,
    // holding each asset's true aspect ratio with no stretching. uReveal is the
    // staggered entry fade, it is not an edge treatment.
