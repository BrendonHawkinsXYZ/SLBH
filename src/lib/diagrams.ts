...
export const diagrams: DiagramRecord[] = [
  ...
  {
    id: "affective-systems-matrix",
    title: "Affective Systems Matrix",
    image: "/diagrams/affective-systems-matrix.png",
    width: 3200,
    height: 4000,
    alt: "A matrix maps affect, emotion, and sentiment across individual, dyadic, group, and cultural scales, with axes labeled temporal resolution and social scale.",
  },
  {
    id: "meaning-field-model",
    title: "Meaning Field Model",
    image: "/diagrams/meaning-field-model.png",
    width: 3200,
    height: 4000,
    alt: "Three intersecting axes map interpretation from negative to positive, activation from dormant to activated, and agency from internal to external.",
  },
  {
    id: "affective-alignment-protocol",
    title: "Affective Alignment Protocol",
    image: "/diagrams/affective-alignment-protocol.png",
    width: 3200,
    height: 4000,
    alt: "Green and orange nodes connect through aligned channels to a yellow mediator within a shared boundary. An indirect channel and an unresolved signal also connect the outer nodes.",
  },
  {
